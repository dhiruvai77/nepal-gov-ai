...
class GroundedPromptBuilder:
    ...
    def __call__(
        ...
        return (
            ...
            "information to answer the question, state that the "
            ...
            "- Cite factual claims from the supplied evidence using "
            "the corresponding evidence labels such as [E1].\n"
            "- Place each evidence label immediately after the sentence "
            "or clause it supports.\n"
            "- Use only evidence labels supplied below. Do not invent "
            "or alter evidence labels.\n"
